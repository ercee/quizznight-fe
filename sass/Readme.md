...
folder are mapped to the application's root namespace, 'QuizzNight.fe'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'QuizzNight.fe' in the same way
as `"QuizzNight.fe/sass/src"`.
